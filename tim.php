...
<input type="hidden" id="tid" value="<?php echo $tid?>" />
       ...
       <button onClick="ld1()" class="w3-button w3-green  w3-hover-light-green" style="float:right; padding:2px; width:70px; height:50px; font-size:25px;"><span class="fa fa-send"></span></button>
